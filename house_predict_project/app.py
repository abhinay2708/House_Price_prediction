...
result_df=pd.read_csv('model_evaluation_results.csv')
...
@app.route('/results')
def results():
    return render_template('model.html',tables=[result_df.to_html(classes='data')],titles=result_df.columns.values)
